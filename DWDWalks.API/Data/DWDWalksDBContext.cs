    ...
    public class DWDWalksDBContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var diff = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id = Guid.Parse("1fddb8b5-6d0f-49c0-acad-1a63a49296d8"),
                    Name = "Easy"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("cfdca9c9-f1c3-4c59-bf7a-554e856fc1c5"),
                    Name = "Medium"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("1035f3b6-6eea-4d77-9732-c0e53751a0f7"),
                    Name = "Hard"
                }
            };
